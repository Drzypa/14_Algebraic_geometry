...
\usepackage{pmmeta}
\pmcanonicalname{AlgebraicTorus}
\pmcreated{2013-03-22 13:53:27}
\pmmodified{2013-03-22 13:53:27}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{algebraic torus}
\pmrecord{7}{34636}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $k$ be a field.  Then $k^*$, the multiplicative group of $k$ is an affine algebraic group over $k$.  An affine algebraic group of the form $(k^*)^n$ is called an {\em algebraic torus} over $k$.

The name is \PMlinkescapetext{connected} to the fact that if $k=\C$, then an algebraic torus is the complexification of the standard torus $(S^1)^n$.
%%%%%
%%%%%
\end{document}
