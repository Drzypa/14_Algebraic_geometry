...
\usepackage{pmmeta}
\pmcanonicalname{NormalVariety}
\pmcreated{2013-03-22 13:20:28}
\pmmodified{2013-03-22 13:20:28}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{normal variety}
\pmrecord{5}{33856}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $X$ be a variety. $X$ is said to be {\em normal} at a point $p\in X$ if  the local ring $\mc{O}_p$ is integrally closed.  $X$ is said to be {\em normal} if it is normal at every point.  If $X$ is non-singular at $p$, it is normal at $p$, since regular local rings are integrally closed.
%%%%%
%%%%%
\end{document}
