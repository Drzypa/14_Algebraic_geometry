...
\usepackage{pmmeta}
\pmcanonicalname{AlgebraicMap}
\pmcreated{2013-03-22 13:53:41}
\pmmodified{2013-03-22 13:53:41}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{algebraic map}
\pmrecord{7}{34641}
\pmprivacy{1}
...
\pmsynonym{algebraic}{AlgebraicMap}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A map $f:X\to Y$ between quasi-affine varieties $X\subset k^n,Y\subset k^m$ over a field $k$ is called \emph{\PMlinkescapetext{algebraic}} if there is a map $f':k^n\to k^m$ whose component functions are polynomials, such that $f'$ restricts to $f$ on $X$.
