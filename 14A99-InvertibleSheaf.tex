...
\usepackage{pmmeta}
\pmcanonicalname{InvertibleSheaf}
\pmcreated{2013-03-22 13:52:34}
\pmmodified{2013-03-22 13:52:34}
\pmowner{Mathprof}{13753}
\pmmodifier{Mathprof}{13753}
\pmtitle{invertible sheaf}
\pmrecord{8}{34619}
\pmprivacy{1}
...
A sheaf $\L$ of $\O_X$ modules on a ringed space $\O_X$ is called \emph{\PMlinkescapetext{invertible}} if there is another sheaf of $\O_X$-modules $\L'$ such that $\L\otimes\L'\cong\O_X$.  A sheaf is invertible if and only if it is locally free of rank 1, and its inverse is the sheaf $\L^{\vee}\cong\mathcal{H}om(\L,\O_X)$, by the \PMlinkescapetext{obvious} map.

The set of invertible sheaves \PMlinkescapetext{obviously} form an abelian group under tensor multiplication, called the Picard group of $X$.
%%%%%
%%%%%
\end{document}
