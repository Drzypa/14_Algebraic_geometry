...
\usepackage{pmmeta}
\pmcanonicalname{AffineAlgebraicGroup}
\pmcreated{2013-03-22 13:53:33}
\pmmodified{2013-03-22 13:53:33}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{affine algebraic group}
\pmrecord{7}{34638}
\pmprivacy{1}
\pmauthor{bwebste}{988}
\pmtype{Definition}
\pmcomment{trigger rebuild}
\pmclassification{msc}{14L17}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
An {\em affine algebraic group} over a field $k$ is quasi-affine variety $G$ (a locally closed subset of affine space) over $k$, which is a equipped with a group \PMlinkescapetext{structure} such that the multiplication map $m:G\times G\to G$ and inverse map $i:G\to G$ are algebraic.

For example, $k$ is an affine algebraic group over itself with the group law being addition, and as is $k^*=k-\{0\}$ with the group law multiplication.  Other common examples of affine algebraic groups are $\GL nk$, the general linear group over $k$ (identifying matrices with affine space) and any algebraic torus over $k$.
%%%%%
%%%%%
\end{document}
