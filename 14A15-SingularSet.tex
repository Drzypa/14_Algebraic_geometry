...
\usepackage{pmmeta}
\pmcanonicalname{SingularSet}
\pmcreated{2013-03-22 13:20:17}
\pmmodified{2013-03-22 13:20:17}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{singular set}
\pmrecord{7}{33852}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
The \emph{singular set} of a variety $X$ is the set of singular points.  This is a proper subvariety.  A subvariety $Y$ of $X$ is contained in the singular set
if and only if its local ring $\mc{O}_Y$ is not \PMlinkname{regular}{RegularLocalRing}.
%%%%%
%%%%%
\end{document}
